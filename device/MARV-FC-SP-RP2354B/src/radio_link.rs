...
use crate::channels::{
    AUX_IMU_CHANNEL, BAROMETER_CHANNEL, DisabledMagnetometerSubscriber, FLIGHT_PHASE_CHANNEL,
    FcBarometerSubscriber, FcFlightPhaseSubscriber, FcGpsSubscriber, FcImuSubscriber, GPS_CHANNEL,
...
async fn radio_link_emitter_task(
    ...
    mut magnetometer: DisabledMagnetometerSubscriber,
) -> ! {
